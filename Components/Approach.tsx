    ...
    <section className="w-full py-20" id="approach">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description = "Crafting clear roadmaps and strategies to guide each project from vision to reality"
          >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description = "Transforming ideas into code with agile development and regular progress insights"
          >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description = "Seamlessly deploying and launching solutions to ensure a smooth transition from development to production"
          >
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    <div>
      <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
        ...
        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-3 py-1 text-2xl font-medium text-purple backdrop-blur-3xl">
          {order}
        </span>
      </button>
    </div>
